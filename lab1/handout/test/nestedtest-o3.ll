; ModuleID = 'nestedtest.ll'
source_filename = "nestedtest.ll"
...
entry:
  %vtpm.1 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([25 x i8], [25 x i8]* @str, i64 0, i64 0), i32 2)
  ret i32 0
}
